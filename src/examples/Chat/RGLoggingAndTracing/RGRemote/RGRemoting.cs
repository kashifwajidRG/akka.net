// //-----------------------------------------------------------------------
// // <copyright file="RGRemoting.cs" company="Akka.NET Project">
...
namespace RGLoggingAndTracing.RGRemote
{
    ...
    {
        protected RGRemoteTransport(ExtendedActorSystem system, RGRemoteActorRefProvider provider)
        {
            System = system;
            Provider = provider;
        }
        ...
        /// TBD
        /// </summary>
        public RGRemoteActorRefProvider Provider { get; private set; }
    ...
    public class RGRemoting : RGRemoteTransport
    {
        ...
        public RGRemoting(ExtendedActorSystem system, RGRemoteActorRefProvider provider)
            : base(system, provider)
        {
            _log = Logging.GetLogger(system, "remoting");
            _eventPublisher = new RGEventPublisher(system, _log, Logging.LogLevelFor(provider.RemoteSettings.RemoteLifecycleEventsLogLevel));
